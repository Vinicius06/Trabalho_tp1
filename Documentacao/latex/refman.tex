...
\vspace*{7cm}
\begin{center}%
{\Large Trabalho TP1 \\[1ex]\large v1.\+0 }\\
\vspace*{1cm}
...
\input{classCodigo}
\input{classData}
\input{classDisciplina}
\input{classMatricula}
\input{classNome}
\input{classProjeto}
\input{classSenha}
\input{classTarefa}
...
\input{classTUCodigo}
\input{classTUData}
\input{classTUDisciplina}
\input{classTUMatricula}
\input{classTUNome}
\input{classTUProjeto}
\input{classTUSenha}
\input{classTUTarefa}
\input{classTUTexto}
\input{classTUUsuario}
\input{classUsuario}
